...
## Kurzbeschreibung
WG-ShopSync ist eine mobile Anwendung zur Organisation gemeinsamer Einkäufe in Wohngemeinschaften.
...
- **Frameworks:** Flutter (Mobile App), Node.js
- **Persistenz:** SQLite (lokal), Cloud-Datenbank
