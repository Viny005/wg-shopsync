...
| TECH-07 | Eingeschränkter Offline-Modus | Bereits synchronisierte Einkaufslistendaten können offline angezeigt werden; neue Artikel können als ausstehende Firestore-Schreibvorgänge vorgemerkt werden. Konfliktgeschütztes Bearbeiten und Als-gekauft-Markieren sowie Registrierung, Login ohne lokale Sitzung, WG-Erstellung und WG-Beitritt benötigen eine Verbindung. Siehe [N1.3-03](../spec/N1-nichtfunktional-anforderungen.md#n133-offline-verfügbarkeit) und [N2.3](../spec/N2-querschnittskonzepte.md#n23-offline-modus). |
